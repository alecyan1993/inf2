...
torch_neuronx.dynamic_batch(text_encoder_neuron)
...
# # Compile vae decoder
decoder_in = torch.randn([1, 4, 96, 64])
with torch.no_grad():
...
torch_neuronx.dynamic_batch(decoder_neuron)
...
# Compile unet - FP32
sample_1b = torch.randn([1, 4, 96, 64])
...
torch_neuronx.dynamic_batch(unet_neuron)
...
post_quant_conv_in = torch.randn([1, 4, 96, 64])
with torch.no_grad():
...
torch_neuronx.dynamic_batch(post_quant_conv_neuron)
